import dataclasses
from jaxmarl.environments.smax.smax_toy import SMAX
from jaxmarl.environments.smax.smax_toy import State as SMAXState
...
class EnemySMAX(MultiAgentEnv):
    ...
    def step_env(
        ...
        enemy_actions = jnp.array([4 for i in self.enemy_agents])
